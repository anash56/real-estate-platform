...
export default function EditListing() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 mt-8 min-h-screen">
      ...
      <form className="bg-white p-8 rounded-xl shadow border border-gray-100 space-y-6" onSubmit={handleSubmit}>
        <div>
        ...
        <div className="flex gap-4 pt-4 border-t mt-8">
          ...
          <button type="submit" disabled={isSubmitting} className="flex-1 bg-blue-600 text-white font-bold py-3 rounded hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed">
